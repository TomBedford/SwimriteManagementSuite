...
/**
 * The extended JTable intended to hold all Teachers from the sms database.
 */
public class TeacherTable extends JTable {
     ...
     */
    private final String[] columnToolTips = {"The name of the Teacher",
                                        "Whether the teacher works Mondays or not",
                                        "Whether the teacher works Tuesdays or not",
                                        "Whether the teacher works Wednesdays or not",
                                        "Whether the teacher works Thursdays or not",
                                        "Whether the teacher works Fridays or not",
                                        "Whether the teacher works Saturdays or not",
                                        "Whether the teacher works Sundays or not"};
    
    /**
     * Constructor to create the specifically designed Teacher table.
     * @param model the table model (inc. data and table column headings)
     */
    public TeacherTable(TableModel model) {
        ...
        this.setPreferredScrollableViewportSize(new Dimension(1200, 500));
    ...
    /**
     * Stops teacher cells from being editable.
