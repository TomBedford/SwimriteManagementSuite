...
/**
 * A Table designed specifically to hold student record details.
 */
public class StudentRecordTable extends JTable {
    ...
    /**
     * Constructor to create the specifically design student record table.
     * @param model the table model (inc. data and table column headings)
     */
    public StudentRecordTable(TableModel model) {
