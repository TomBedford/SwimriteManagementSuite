...
/**
 * The extended JTable intended to hold all Login Accounts from the sms database.
 */
public class LoginAccountTable extends JTable {
     ...
     */
    private final String[] columnToolTips = {"The username of the Login Account",
                                        "Whether the Login Account is an Administrator or not"};
    
    /**
     * Constructor to create the specifically designed Login Account table.
     * @param model the table model (inc. data and table column headings)
     */
    public LoginAccountTable(TableModel model) {
    ...
    /**
     * Stops Login Account cells from being editable.
